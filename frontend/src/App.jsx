...
function App() {
  ...
  const indexDocumentation = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get(`https://chat-backend-cdr8.onrender.com/api/index/${selectedCDP}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.get(`https://chat-backend-cdr8.onrender.com/api/ask?query=${encodeURIComponent(userMessage)}`);
